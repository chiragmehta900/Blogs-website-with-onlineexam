...
.col-md-6 lable:hover {
  color: red;
}
}
</style>
<div class="row">
	<div class="col-md-8 exam_two" >
		<div class="card">
			<div class="card-header" style="display: flex; justify-content: space-between;">Online Exam <a href="enroll_exam.php" class="btn btn-danger btn-sm" >Leave Exam</a></div>
...
$(document).ready(function(){
	...
	setInterval(function(){
		...
		{
			alert('Exam time over wait for result. ');
			location.replace("http://testing.snproweb.com/tutorial/online_examination")
		}
	}, 1000);
